...
//CLIENTS
// router.post("/get-client-details", NfaFeatureController.getUserType);
...
// $router->get('delete-entry/{id}',               ['uses' =>  'ClientController@entryDelete']);
// $router->get('entry-list',                      ['uses' =>  'ClientController@entryList']);
// $router->post('logout',                         ['uses' =>  'ClientController@logout']);
